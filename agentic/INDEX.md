...
| [silent-fake-success-fail-loud-never-fake.md](silent-fake-success-fail-loud-never-fake.md) | silent failure, fake success, error handling, fallbacks, mock data, debuggability, integration tests, adversarial review, linters, pre-commit | Preventing AI-assisted codebases from hiding broken integrations behind plausible output; designing “fail loud” contracts and deterministic enforcement | Failure mode definition; why it happens; fail-loud contract; engineering techniques; enforcement layers; takeaway |
